...
Authors: Xiao (Shell) Yan & Ron Giambalvo 

Description: This application runs on an Android-compatible mobile device.
The Timer application behaves as follows:
...
PATH to Activity test:

cs313f12p1a / test / src / hola / newtimer / test

Path to Model tests:

cs313f12p1a / test / src / hola / newtimer / model / test
